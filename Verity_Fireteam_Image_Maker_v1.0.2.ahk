...
F3::
{
    InputBox delay_time, Fireteam Image Maker, Input the amount of time to wait after inspecting a player.`nDefault: 2000`nIncrease this number if loading slowly.,,,,,,,, 2000
    If ErrorLevel = 0 
    {
        Send u
        Sleep 1000
        ...
        loop, 6
        {
            ...
            snap := Gdip_BitmapFromScreen(coords)u
